...
int DrawGLScene(GLvoid)
{
	...
	glColor3f(1.f  * (float)cos(cnt1), 1.f * (float)sin(cnt2), 1.f - .5f * (float)cos(cnt1 + cnt2));
	glRasterPos2f(-.45f + .05f * cos(cnt1), .35 * sin(cnt2));
	glPrint("OpenGL text testing, hahaha - %7.2f", cnt1);
	cnt1 += .0001f;
	cnt2 += .0005f;
	return TRUE;
}
